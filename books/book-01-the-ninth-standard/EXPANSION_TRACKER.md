...
## Rules
- Preserve existing canon, reveal order, and chapter endings unless a continuity fix is required.
- Add scenes, not filler: school routines, relationship turns, training, study, consequences, class/status texture, family contact, campus rituals, and supporting-character goals.
- Keep the family-clean rule locked.
- Maintain audio-first readability and single-narrator clarity.
- Preserve hard Resonance/Boundary bookkeeping and neurological cost.
- Do not accelerate Kade/Mara romance at the expense of rivalry/trust.
- Each expanded scene must do at least two jobs: character + world, character + plot, plot + theme, or world + foreshadowing.
...
| 3 | Asterion | 5,700 | Pending |
| 4 | Ten Thousand Four Hundred Eighty-Two | 5,300 | Pending |
| 5 | House Meridian | 5,400 | Pending |
...
| 21 | Midyear: Open Rounds | 6,200 | Pending |
...
- **Block B:** Chapters 11–21
- **Block C:** Chapters 22–33

The existing polished prose is the base. Expansion should make readers live at Northline/Asterion rather than merely receive the planned beats.
